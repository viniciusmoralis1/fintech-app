...
export default function Mastercard() {
  return (
    <View style={styles.container}>
      ...
      >
        <Path d="M182.298,145.895c0,50.366-40.801,91.176-91.149,91.176S0,196.252,0,145.895
          s40.811-91.176,91.149-91.176S182.298,95.538,182.298,145.895z"
          fill="#E2574C"
        />
        <Path d="M200.616,54.719c-20.442,0-39.261,6.811-54.469,18.181l0.073,0.009
